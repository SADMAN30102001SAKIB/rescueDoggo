const Game = Phaser.Class({
    ...
    create: function(){
        ...
        this.background.displayWidth = window.innerWidth * 2;
	...
	if (this.desktop){
        this.leftButton = this.add.dom(-50, 0, "button", `
        `, "");
        ...
        this.rightButton = this.add.dom(-50, 0, "button", `
        `, "");
        ...
        this.jumpButton = this.add.dom(-50, 0, "button", `
        `, "");
        ...
        this.jumpButton = this.add.dom(240, 510, "button", `
            width: 130px;
            height: 120px;
            color: #000;
            font-weight: bold;
